...
def index():
    ...
    data = {
        'Energía Renovable' : ['Eolica', 'Solar', 'Hidroelectrica'],
    ...
    #-----------------------------------------------------------------------------------------------------------------------
    #------------------------------------------------Grafica de lineas------------------------------------------------------
    wind_data = pd.read_csv('Website/static/archivo/09 cumulative-installed-wind-energy-capacity-gigawatts.csv')
    solar_data = pd.read_csv('Website/static/archivo/13 installed-solar-PV-capacity.csv')
    ...
    plt.plot(wind_data['Year'],wind_data['Wind Capacity'], label='Capacity Eolica', color='blue', marker='o')
    plt.plot(solar_data['Year'], solar_data['Solar Capacity'], label='Capacity Solar', color='orange', marker='x')
    ...
    #-----------------------------------------------------------------------------------------------------------------------
    #---------------------------------------------------grafica de area-----------------------------------------------------
    renewable_data = pd.read_csv('Website/static/archivo/02 modern-renewable-energy-consumption.csv')
    ...
    ax.set_title('Comparación entre Consumo de Energía Renovable y Convencional', fontsize=14)
